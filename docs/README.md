...
| 2026-09-20 | [v0.2 实施规划](plan/2026-09-20-v0.2-plan.md) | 规划草案（待裁决轮） | 波次 W0-W5（裁决轮/引擎加固 → dogfooding → 多节点 → S3+Cron → 数据库托管 → MCP/metrics/终端）；七项前置裁决（D-V2-1~7）；v0.1 挂账归属表；借鉴/避坑红线（源自 zane-ops 调研）；≈61-99 人日 |
