...
| 2026-09-20 | [v0.2 实施规划](plan/2026-09-20-v0.2-plan.md) | 规划草案（待裁决轮） | 波次 W0-W5（裁决轮/引擎加固 → dogfooding → 多节点 → S3+Cron → 数据库托管 → MCP/观测/终端）；前置裁决 D-V2-1~7（V2-1 已裁决：易用性提级、预算顶 600MB、VictoriaLogs 默认捆绑）；v0.1 挂账归属表；借鉴/避坑红线（源自 zane-ops 调研）；≈62-102 人日 |
